...
<option value="选择">- - - - 请选择一种类型- - - - </option>
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="inputContent">&nbsp;<font color="#CC0000">必须填写，以便联系</font></td>
          </tr>
                         <tr>
            <td class="inputHeader">&nbsp;</td>
            <td class="inputHeader"></td>
          ...
          <tr>
            <td class="inputHeader">&nbsp;</td>
            <td class="inputHeader">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 箱：</td>
            <td class="inputContent">
              <input type="text"  name="address"  maxlength="25"  class="text width100">
            </td>
            <td class="inputContent">&nbsp;<font color="#CC0000">可以不填写</font></td>
          </tr>
                    <tr>
            <td class="inputHeader">&nbsp;</td>
            <td class="inputHeader"></td>
